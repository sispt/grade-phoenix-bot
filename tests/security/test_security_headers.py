...
"""
import pytest
from security.headers import SecurityHeaders, SecurityPolicy, security_headers, security_policy
...
class TestSecurityPolicy:
    ...
    def test_validate_url_blocked_patterns(self):
        ...
        assert not policy.validate_url('https://api.telegram.org/bot123/sendMessage?onload=evil')
