...
2. أدخل اسم المستخدم الجامعي (مثال: ENG2324901)
3. أدخل كلمة المرور
...
• ستتلقى إشعارات تلقائية عند تحديث الدرجات
• البوت يفحص الدرجات كل 5 دقائق تلقائياً
...
• إشعارات النظام والأخطاء

💡 **نصائح مهمة:**
• تأكد من صحة بياناتك الجامعية
• إذا انتهت صلاحية الجلسة، اضغط "🔄 إعادة تسجيل الدخول"
• البوت يحفظ بياناتك بأمان
• يمكنك استخدام البوت من أي مكان
