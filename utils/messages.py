...
def get_welcome_message(fullname: str | None = None) -> str:
    ...
    name_line = f"أهلاً وسهلاً {fullname}! 👋\n\n" if fullname else "مرحباً بك! 👋\n\n"

    return (
        name_line
        + "🎓 **ما هو هذا البوت؟**\n"
        + "بوت ذكي لمتابعة درجاتك الجامعية بسهولة وأمان!\n\n"
        + "✨ **الميزات الرئيسية:**\n"
        + "• 📊 عرض درجاتك الحالية والسابقة\n"
        + "• 🔔 إشعارات فورية عند تحديث الدرجات\n"
        + "• 📱 واجهة سهلة الاستخدام\n"
        + "• 🔐 حماية كاملة لبياناتك\n\n"
        + "🚀 **للبدء:**\n"
        + "اضغط على '🚀 تسجيل الدخول للجامعة' وأدخل بياناتك\n\n"
        + "🔐 **الأمان:**\n"
        + "• تشفير كامل للبيانات\n"
        + "• معايير أمان عالية (OWASP + NIST)\n"
        + "• لا نخزن كلمات المرور نهائياً\n"
        + "• لا يتم فحص أو جلب درجاتك أو الاطﻻع عليها من قبل المطور إلا عندما تطلب ذلك بنفسك.\n\n"
        + f"👨‍💻 المطور: {CONFIG['ADMIN_USERNAME']}\n"
        + "\n🌐 [رابط الكود البرمجي (GitHub) - للشفافية الكاملة ومعرفة كيف يعمل البوت](https://github.com/sispt/grade-phoenix-bot?refresh)\n"
        + "\nإذا أردت نسخة من بياناتك يمكنك التواصل مع المطور مباشرة (ﻻ يشمل كلمة المرور لأننا ﻻ نحتفظ بها، فقط بيانات الدرجات)."
    )
...
def get_simple_welcome_message() -> str:
    ...
    return (
        ...
        + "**ماذا يفعل البوت؟**\n"
        + "• يعرض درجاتك الجامعية بسهولة\n"
        + "• يخبرك فوراً عند تحديث الدرجات\n"
        + "• واجهة بسيطة وسهلة الاستخدام\n"
        + "• حماية كاملة لبياناتك\n\n"
        + "**كيف تبدأ؟**\n"
        + "اضغط '🚀 تسجيل الدخول للجامعة' وأدخل بياناتك الجامعية\n\n"
        + "🔐 **الأمان:**\n"
...
def get_security_welcome_message() -> str:
    ...
    return (
        "مرحباً بعودتك! 🔐\n\n"
        + "✅ **حالة الأمان:** ممتازة (A+)\n"
        + "🔒 **حماية البيانات:** مشفرة بالكامل\n"
        + "🛡️ **معايير الأمان:** OWASP + NIST + GDPR\n\n"
        + "**الأوامر الأمنية:**\n"
        + "🔍 `/security_info` - معلومات الأمان التفصيلية\n"
        + "📋 `/security_audit` - تقرير التدقيق الأمني\n"
        + "🔒 `/privacy_policy` - سياسة الخصوصية\n"
        + "🛡️ `/security_headers` - رؤوس الأمان\n\n"
        + "💡 **استخدم الأزرار أدناه للوصول للميزات**\n"
        + "🎯 **نصيحة:** جرب '📊 درجات الفصل الحالي' لرؤية أحدث درجاتك"
    )
...
def get_support_message() -> str:
    ...
    return (
        ...
        f"أو اضغط الزر أدناه للتواصل مباشرة عبر تيليجرام."
    )
...
def get_help_message() -> str:
    ...
    return (
        "❓ **المساعدة والدعم**\n\n"
        "- يمكنك دائماً معرفة المزيد عن البوت أو الإبلاغ عن مشكلة من خلال الكود البرمجي على GitHub.\n"
        "- هذا الرابط متوفر للشفافية الكاملة: [GitHub](https://github.com/sispt/grade-phoenix-bot?refresh)\n\n"
        "- إذا أردت نسخة من بياناتك المخزنة على البوت يمكنك التواصل مع المطور مباشرة (ﻻ يشمل كلمة المرور لأننا ﻻ نحتفظ بها، فقط بيانات الدرجات).\n\n"
        "- لا يتم تخزين كلمات المرور نهائياً.\n"
        "- لا يتم فحص أو جلب درجاتك إلا عندما تطلب ذلك بنفسك.\n"
        "- لأي استفسار آخر، تواصل مع المطور."
    )
...
def get_error_message(error_type: str = "عام") -> str:
    ...
    error_messages = {
        ...
        "api_error": "🔧 النظام غير متاح حالياً\n\n**معلومات:**\n• قد يكون النظام في صيانة\n• جرب مرة أخرى بعد 5-10 دقائق\n• إذا استمرت المشكلة، تواصل مع الدعم\n\n📞 للمساعدة: اضغط '📞 الدعم الفني'",
        "token_expired": "⏰ انتهت صلاحية الجلسة\n\n**الحل:**\n• اضغط '🔄 إعادة تسجيل الدخول'\n• أدخل بياناتك مرة أخرى\n• هذا طبيعي ويحدث كل فترة\n\n🔐 بياناتك آمنة ومشفرة",
        "no_grades": "📊 لا توجد درجات متاحة حالياً\n\n**الأسباب المحتملة:**\n• لم يتم نشر الدرجات بعد\n• قد تكون في فترة إجازة\n• تحقق من النظام لاحقاً\n\n📞 للمساعدة: اضغط '📞 الدعم الفني'",
...
def get_info_message(info_type: str) -> str:
    ...
    info_messages = {
        "not_registered": "❌ لم يتم تسجيلك بعد\n\n**للبدء:**\n• اضغط على '🚀 تسجيل الدخول للجامعة'\n• أدخل اسم المستخدم وكلمة المرور\n• ستتمكن من الوصول لجميع الميزات\n\n🔐 **الأمان:**\nبياناتك مشفرة ومحمية بالكامل",
        "no_permission": "🚫 ليس لديك صلاحية الوصول\n\n**المعلومات:**\n• هذه الميزة متاحة للمطور فقط\n• إذا كنت المطور، تأكد من إعدادات الحساب\n• للمساعدة، تواصل مع الدعم\n\n📞 للمساعدة: اضغط '📞 الدعم الفني'",
        "maintenance": "🔧 البوت في الصيانة حالياً\n\n**المعلومات:**\n• يتم إجراء تحديثات وتحسينات\n• جرب مرة أخرى بعد 10-15 دقيقة\n• إذا استمرت المشكلة، تواصل مع الدعم\n\n📞 للمساعدة: اضغط '📞 الدعم الفني'",
        "coming_soon": "🚧 قريباً: هذه الميزة ستتوفر لاحقاً\n\n**الميزات القادمة:**\n• تحسينات على الواجهة\n• ميزات إضافية\n• تحسينات على الأمان\n\n💡 **نصيحة:** تابع التحديثات للحصول على أحدث الميزات",
    }
...
def get_registration_success_message(username: str) -> str:
    ...
    return (
        ...
        f"🎉 **مرحباً {username}**\n\n"
        f"🎓 **مرحباً بك في نظام الإشعارات الجامعية**\n\n"
        f"**يمكنك الآن:**\n"
        f"• 📊 متابعة درجاتك بسهولة\n"
        f"• 🔔 استلام إشعارات فورية\n"
        f"• 📱 استخدام واجهة سهلة\n"
        f"• 🔐 الاستمتاع بحماية كاملة\n\n"
        f"💡 **:** جرب '📊 درجات الفصل الحالي' لرؤية أحدث درجاتك\n\n"
        f"🔐 **الأمان:**\n"
        f"بياناتك مشفرة ومحمية بالكامل"
    )
