...
**Version:** 2.0.1 | **Security Rating: A+** | **Status: Production Ready**
...
- `BOT_VERSION`: (optional) Version string (default: 2.0.1)
...
| `BOT_VERSION` | Bot version | ✅ | Set via env var (default: 2.0.1) |
...
**Version:** Set via BOT_VERSION env var (default: 2.0.1)
