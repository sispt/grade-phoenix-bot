...
# Grade Phoenix Bot v3.0.0

**Version:** v3.0.0 | **Security Rating: A+** | **Status: Production Ready**
...
- `BOT_VERSION`: (optional) Version string (default: v3.0.0)
...
| `BOT_VERSION` | Bot version | ✅ | Set via env var (default: v3.0.0) |
...
**Version:** Set via BOT_VERSION env var (default: v3.0.0)
